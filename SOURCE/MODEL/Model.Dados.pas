...
begin
  ...
  if (pCds.Locate(aFields[0], FCodigo, [])) then
     Msg('Já existe um registro cadastrado com este código [' + FCodigo.ToString + '] !!!', 3)
  else if (pCds.Locate(aFields[1], FDescricao, [])) then
     Msg('Já existe um registro cadastrado com esta descrição [' + FDescricao + '] !!!', 3)
  else
     begin
